...
import { getDatosHome } from '@/services/homeServide';
import { onMounted, ref } from 'vue';
let datos = ref([]); //declarar una variable reactiva
              ...
              <div class="row h-100 align-items-center">
                <div class="col-12">
                  <div class="breadcumb-text text-center">
                    <h2>Recetas flaites - Desarrollado con vue3</h2>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="section-heading">
                    <h3>Algunas de nuestras recetas publicadas  </h3>
                  </div>
                </div>
              </div>
