            ...
            <Form :validation-schema="registroSchema" @submit="enviar()">
              <div class="row">
                <div className="col-12 col-lg-12">
                  ...
                  <Field type="text"  name="nombre" v-model="nombre" class="form-control" placeholder="Nombre Completo" />
                </div>
                <div className="col-12 col-lg-12">
                ...
                <div className="col-12 col-lg-12">
                  ...
                  <Field type="password"  name="password" v-model="password" class="form-control" placeholder="Contraseña" />
                </div>
