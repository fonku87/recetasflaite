...
<template>
              ...
              <tbody>
                <tr v-for="(dato, index) in datos.data" :key="index">
                  ...
                  <td class="text-center">
                    ...
                    &nbsp;&nbsp;
                    <router-link to="#" @click.prevent="eliminar(dato.id)" title="Eliminar">
  ...
  <div class="modalmask" id="modal2">
    <div class="modalbox rotate">
      <a href="#close" title="Cerrar" class="close" id="">X</a>
      <h2>{{ modal_titulo }}</h2>
      <!--formulario-->
      <Form :validation-schema="recetasSchema" @submit="enviar()">
        <div class="contact-form-area">
          <div class="row container">
            ...
            <div class="col-12 col-lg-12">
              <ErrorMessage name="tiempo" class="text-danger" />
            ...
            <div class="col-12 col-lg-12">
              ...
              <Field as="textarea" name="descripcion" v-model="descripcion" placeholder="Descripción"
                class="form-control" />
            </div>
